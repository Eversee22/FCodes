...
bool MeshViewApp::Init()
{
	...
	std::wstring texRootDir = L"../../Textures/";
	mSky  = new Sky(md3dDevice, texRootDir + L"skymap.dds", 5000.0f);
	...
	mTreeModel = new BasicModel(md3dDevice, mTexMgr, "Models\\tree.m3d", texRootDir);
	mBaseModel = new BasicModel(md3dDevice, mTexMgr, "Models\\base.m3d", texRootDir);
	mStairsModel = new BasicModel(md3dDevice, mTexMgr, "Models\\stairs.m3d", texRootDir);
	mPillar1Model = new BasicModel(md3dDevice, mTexMgr, "Models\\pillar1.m3d", texRootDir);
	mPillar2Model = new BasicModel(md3dDevice, mTexMgr, "Models\\pillar2.m3d", texRootDir);
	mPillar3Model = new BasicModel(md3dDevice, mTexMgr, "Models\\pillar5.m3d", texRootDir);
	mPillar4Model = new BasicModel(md3dDevice, mTexMgr, "Models\\pillar6.m3d", texRootDir);
	mRockModel = new BasicModel(md3dDevice, mTexMgr, "Models\\rock.m3d", texRootDir);
