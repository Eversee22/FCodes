...
void BoxApp::BuildFX()
{
	...
	//ID3D10Blob* compiledShader = 0;  //don't need
	ID3D10Blob* compilationMsgs = 0;
	HRESULT hr = D3DX11CompileEffectFromFile(L"FX/color.fx", nullptr, D3D_COMPILE_STANDARD_FILE_INCLUDE, shaderFlags,
		0, md3dDevice, &mFX, &compilationMsgs);
