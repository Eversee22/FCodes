...
bool TreeBillboardApp::Init()
{
	...
	HR(DirectX::CreateDDSTextureFromFile(md3dDevice, 
		L"../../Textures/grass.dds", &texRes, &mGrassMapSRV, 0 ));
	ReleaseCOM(texRes);

	HR(DirectX::CreateDDSTextureFromFile(md3dDevice,
		L"../../Textures/water2.dds", &texRes, &mWavesMapSRV, 0 ));
	ReleaseCOM(texRes);

	HR(DirectX::CreateDDSTextureFromFile(md3dDevice,
		L"../../Textures/WireFence.dds", &texRes, &mBoxMapSRV, 0 ));
	ReleaseCOM(texRes);
	
	HR(DirectX::CreateDDSTextureFromFile(md3dDevice,
		L"../../Textures/treeArray.dds", &texRes, &mTreeTextureMapArraySRV, 0));
	ReleaseCOM(texRes);
