...
bool MirrorApp::Init()
{
	...
	HR(DirectX::CreateDDSTextureFromFile(md3dDevice,
		L"../../Textures/brick01.dds", 0, &mWallDiffuseMapSRV, 0 ));

	HR(DirectX::CreateDDSTextureFromFile(md3dDevice,
		L"../../Textures/ice.dds", 0, &mMirrorDiffuseMapSRV, 0 ));
...
void MirrorApp::DrawScene()
{
	...
	for(UINT p = 0; p < techDesc.Passes; ++p)
    {
		...
		//md3dImmediateContext->OMSetDepthStencilState(RenderStates::DrawWallDSS, 0);
		pass->Apply(0, md3dImmediateContext);
