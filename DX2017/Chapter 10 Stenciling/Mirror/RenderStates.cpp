...
ID3D11DepthStencilState* RenderStates::DrawWallDSS = 0;
...
void RenderStates::InitAll(ID3D11Device* device)
{
	...
	//D3D11_DEPTH_STENCIL_DESC drawWallDesc;
	//drawWallDesc.DepthEnable = false;
	//drawWallDesc.DepthWriteMask = D3D11_DEPTH_WRITE_MASK_ALL;
	//drawWallDesc.DepthFunc = D3D11_COMPARISON_LESS;
	//drawWallDesc.StencilEnable = false;
	//drawWallDesc.StencilReadMask = 0xff;
	//drawWallDesc.StencilWriteMask = 0xff;

	//drawWallDesc.FrontFace.StencilFailOp = D3D11_STENCIL_OP_KEEP;
	//drawWallDesc.FrontFace.StencilDepthFailOp = D3D11_STENCIL_OP_KEEP;
	//drawWallDesc.FrontFace.StencilPassOp = D3D11_STENCIL_OP_KEEP;
	//drawWallDesc.FrontFace.StencilFunc = D3D11_COMPARISON_ALWAYS;

	// //We are not rendering backfacing polygons, so these settings do not matter.
	//drawWallDesc.BackFace.StencilFailOp = D3D11_STENCIL_OP_KEEP;
	//drawWallDesc.BackFace.StencilDepthFailOp = D3D11_STENCIL_OP_KEEP;
	//drawWallDesc.BackFace.StencilPassOp = D3D11_STENCIL_OP_KEEP;
	//drawWallDesc.BackFace.StencilFunc = D3D11_COMPARISON_ALWAYS;
	//
	//HR(device->CreateDepthStencilState(&drawWallDesc, &DrawWallDSS));
}
