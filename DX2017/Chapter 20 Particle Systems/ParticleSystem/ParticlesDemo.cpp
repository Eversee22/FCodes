...
bool ParticlesApp::Init()
{
	...
	mSky = new Sky(md3dDevice, texRootDir + L"grasscube1024.dds", 5000.0f);

	Terrain::InitInfo tii;
	tii.HeightMapFilename = texRootDir + L"terrain.raw";
	tii.LayerMapFilename = texRootDir + L"texArray.dds";
	/*tii.LayerMapFilename0 = L"Textures/grass.dds";
	tii.LayerMapFilename1 = L"Textures/darkdirt.dds";
	tii.LayerMapFilename2 = L"Textures/stone.dds";
	tii.LayerMapFilename3 = L"Textures/lightdirt.dds";
	tii.LayerMapFilename4 = L"Textures/snow.dds";*/
	tii.BlendMapFilename = texRootDir + L"blend.dds";
	...
	HR(DirectX::CreateDDSTextureFromFile(md3dDevice, 
		L"../../Textures/flareArray.dds", &texRes, &mFlareTexSRV));
	ReleaseCOM(texRes);
	...
	HR(DirectX::CreateDDSTextureFromFile(md3dDevice,
		L"../../Textures/raindropArray.dds", &texRes, &mRainTexSRV));
	ReleaseCOM(texRes);
